...
export default function BrowseGigs() {
  ...
  const handleSearch = (query: string) => {
    ...
    if (query.trim() === '') {
      ...
      searchGigs(query).then((result) => setDisplayGigs(result))
    }
  }
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      {openGigs.length === 0 ? (
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {openGigs.map((gig) => (
            <div key={gig._id} className="bg-white rounded-lg shadow-md border border-gray-200 p-6 hover:shadow-lg transition-shadow">
              <div className="mb-4">
